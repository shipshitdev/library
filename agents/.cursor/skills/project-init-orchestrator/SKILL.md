...
│  ──────────────────────────────────────────────────────────│
│  Invocation:                                                │
│  python3 ~/.cursor/skills/agent-folder-init/scripts/       │
...
│  ──────────────────────────────────────────────────────────│
│  Invocation:                                                │
│  python3 ~/.cursor/skills/project-scaffold/scripts/        │
│          scaffold.py                                        │
└─────────────────────────────────────────────────────────────┘
                           │
                           ▼
...
**Phase 2: Agent Folder Init**
```bash
python3 ~/.cursor/skills/agent-folder-init/scripts/scaffold.py --root /path/to/project
```
