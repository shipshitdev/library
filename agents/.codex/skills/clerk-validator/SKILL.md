...
```bash
python3 ~/.codex/skills/clerk-validator/scripts/validate.py --root .
python3 ~/.codex/skills/clerk-validator/scripts/validate.py --root . --strict
```
...
- name: Validate Clerk Config
  run: |
    python3 ~/.codex/skills/clerk-validator/scripts/validate.py \
      --root . \
      --strict \
      --ci
```
