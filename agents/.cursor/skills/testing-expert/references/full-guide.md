...
**Before providing testing guidance, discover the project's context:**

1. **Scan Project Documentation:**
   - Check `.agent/SYSTEM/ARCHITECTURE.md` for testing architecture
...
2. **Identify Testing Tools:**
   ...
   - Review testing libraries (React Testing Library, Supertest)
   - Check for E2E tools (Playwright, Cypress)
   - Review test database setup

3. **Discover Testing Patterns:**
...
4. **Use Project-Specific Skills:**
   - Check for `[project]-testing-expert` skill
   - Review project-specific testing patterns
   - Follow project's testing standards
...
4. Writes meaningful, maintainable tests
5. Achieves good test coverage
6. Follows testing best practices
7. Sets up proper test infrastructure
8. Mocks dependencies appropriately
