...
- User mentions customer personas
- User is unsure who to sell to
- User says "everyone could use this"
- User asks "who should I target first"
- User needs to narrow their focus
...
### Step 9: ICP Summary Documentation

**Create a shareable ICP document.**
...
|-------|----------------------|
| `idea-validator` | Validate the problem for this ICP |
| `market-sizer` | Size this specific segment |
| `leads-researcher` | Find companies matching ICP |
| `offer-architect` | Design offer for this ICP |
| `outbound-optimizer` | Write outreach to this ICP |
| `mvp-architect` | Build for this specific user |
