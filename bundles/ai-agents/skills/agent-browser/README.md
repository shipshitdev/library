...
Drive a headless browser from the CLI — navigate, fill forms, screenshot, mock network, and extract data for web testing.

## Upstream

Derived from **[vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser)** (Apache-2.0).

| Field | Value |
|-------|-------|
| Source | [`skills/agent-browser/SKILL.md`](https://github.com/vercel-labs/agent-browser/blob/main/skills/agent-browser/SKILL.md) |
| Upstream ref | `main` |
| Synced at commit | `d33bdb36f3f7` |
