...
```bash
python3 ~/.codex/skills/bun-validator/scripts/validate.py --root .
python3 ~/.codex/skills/bun-validator/scripts/validate.py --root . --strict
```
...
- name: Validate Bun Workspace
  run: |
    python3 ~/.codex/skills/bun-validator/scripts/validate.py \
      --root . \
      --strict \
      --ci
```
