...
## Install via Symlink
```bash
ln -s /path/to/skills/.codex/skills/project-scaffold ~/.codex/skills/project-scaffold
```

## Install via Copy
```bash
cp -r /path/to/skills/.codex/skills/project-scaffold ~/.codex/skills/project-scaffold
```
...
## Verify Installation
```bash
ls -la ~/.codex/skills/project-scaffold
python ~/.codex/skills/project-scaffold/scripts/scaffold.py --help
```
...
```bash
python ~/.codex/skills/project-scaffold/scripts/scaffold.py
```
...
```bash
ln -s /path/to/skills/.codex/skills/agent-folder-init ~/.codex/skills/agent-folder-init
```
