...
python3 ~/.codex/skills/shadcn-setup/scripts/setup.py --root .

# With specific theme
python3 ~/.codex/skills/shadcn-setup/scripts/setup.py --root . --theme zinc

# Install specific components
python3 ~/.codex/skills/shadcn-setup/scripts/setup.py --root . --components button,card,input,dialog

# Next.js App Router (default)
python3 ~/.codex/skills/shadcn-setup/scripts/setup.py --root . --app-router

# Next.js Pages Router
python3 ~/.codex/skills/shadcn-setup/scripts/setup.py --root . --pages-router
```
...
```bash
python3 ~/.codex/skills/tailwind4-validator/scripts/validate.py --root . --verbose
```
