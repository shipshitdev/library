# The 4-D Prompt Optimization Framework (Lyra-Inspired)

Systematic workflow for transforming a vague prompt into a precision-crafted
one. Use it when optimizing an existing prompt — a generation prompt, a
template in a service or pipeline, or a system prompt — or when debugging poor
AI responses.
...
Common issues: vague terms ("make it good"), missing context, no examples,
poor structure.
...
- **Creative tasks:** role assignment, tone emphasis, audience specification,
  examples, brand voice constraints.
- **Technical tasks:** constraint-based, step-by-step structure, error handling
  specs, output format specification.
- **Complex requests:** chain-of-thought, systematic frameworks, subtask
  decomposition, validation steps.
...
Provide 2-3 examples of desired output format and quality level before the
actual request.
