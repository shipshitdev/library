...
This skill enables Claude to discover email addresses associated with a domain using a hybrid approach. Claude will use free methods first (web scraping, pattern guessing, WHOIS lookup) and can optionally use APIs (Hunter.io, Apollo.io, etc.) for enhanced results when API keys are available.
