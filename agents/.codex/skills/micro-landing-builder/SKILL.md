...
```bash
# Show help
python3 ~/.codex/skills/micro-landing-builder/scripts/scaffold.py --help

# Create a new landing
python3 ~/.codex/skills/micro-landing-builder/scripts/scaffold.py \
  --slug mystartup \
  --name "My Startup" \
...
```bash
# From CSV file
python3 ~/.codex/skills/micro-landing-builder/scripts/batch_create.py \
  --root ~/www/landings \
  --csv projects.csv \
  --allow-outside
...
python3 ~/.codex/skills/micro-landing-builder/scripts/deploy_vercel.py \
