...
Explains subsystem architecture and runtime flow. Critique mode adds independent architectural critics.
...
| Field | Value |
|-------|-------|
| Source | [`pstack/skills/how/SKILL.md`](https://github.com/cursor/plugins/blob/main/pstack/skills/how/SKILL.md) |
| Upstream ref | `main` |
...
**Checking for upstream changes:** when upstream has moved ahead of the synced marker above, diff [`pstack/skills/how/SKILL.md`](https://github.com/cursor/plugins/blob/main/pstack/skills/how/SKILL.md) on `main` since commit `bdf7aa355337`, port anything worth bringing home, then bump `metadata.upstream_commit` (or `metadata.upstream_version`) and `metadata.last_synced` in `SKILL.md` and this table.
