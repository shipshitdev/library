...
### 2. @agenticindiedev/ui Components

```typescript
// ✅ Use shared UI components
import { Button, Card, Modal } from "@agenticindiedev/ui";

<Button variant="primary">Primary</Button>
<Card>...</Card>
<Modal open>...</Modal>

// ❌ Don't recreate base UI components
...
- [ ] Uses @agenticindiedev/ui components where applicable
