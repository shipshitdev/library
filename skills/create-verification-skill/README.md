...
Authors a launch/doctor/drive harness for the real app and proves it once end to end.
...
| Field | Value |
|-------|-------|
| Source | [`pstack/skills/create-verification-skill/SKILL.md`](https://github.com/cursor/plugins/blob/main/pstack/skills/create-verification-skill/SKILL.md) |
| Upstream ref | `main` |
