...
description: This skill should be used when users need to implement Stripe payment processing, subscription management, webhook handling, or customer management in Next.js or NestJS applications. It activates when users ask about Stripe integration, payment processing, subscriptions, webhooks, or Stripe API implementation.
---
...
This skill enables Claude to implement comprehensive Stripe integrations including payment processing, subscription management, webhook handling, and customer management for Next.js and NestJS applications. Claude will use this skill to set up Stripe, implement payment flows, handle subscriptions, process webhooks, and manage customer data securely.
