...
Plan the UX and UI of a feature before any code — a structured discovery interview that produces a handoff-ready design brief.
...
| Field | Value |
|-------|-------|
| Source | [`skill/reference/shape.md`](https://github.com/pbakaus/impeccable/blob/main/skill/reference/shape.md) |
