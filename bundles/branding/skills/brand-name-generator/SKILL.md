...
- Need to find available domain names for their brand
- Want to explore different naming styles (modern, classic, playful, professional)

## Project Context Discovery

**Before generating names, discover the context:**

1. **Understand the Business:**
   - What industry or sector?
   - Target audience demographics
   - Brand personality (professional, playful, innovative, trustworthy)
   - Competitor names to avoid similarity

2. **Gather Keywords:**
   - Core concepts the business represents
   - Values and mission keywords
   - Industry-specific terminology
   - Emotional associations desired

3. **Define Constraints:**
   - Preferred name length
   - Starting letter preferences
   - TLD preferences (.com, .io, .ai, .co)
   - Names to avoid (competitors, trademarked terms)
...
### 2. Naming Strategy Framework

#### Strategy Types

| Strategy | Description | Examples | Best For |
|----------|-------------|----------|----------|
| **Portmanteau** | Blend two words | Pinterest, Instagram, Microsoft | Apps, social platforms |
| **Invented** | Create new words | Spotify, Xerox, Häagen-Dazs | Tech, premium brands |
| **Compound** | Join descriptive words | Facebook, YouTube, Snapchat | Clear value proposition |
| **Acronym** | Initialize phrases | IBM, NASA, IKEA | Enterprise, institutions |
| **Misspelling** | Creative respelling | Lyft, Flickr, Tumblr | Startups, apps |
| **Suffix Pattern** | Add brand suffixes | Shopify, Spotify, Grammarly | SaaS, tools |
| **Abstract** | Metaphorical names | Amazon, Apple, Uber | Aspirational brands |
| **Founder** | Personal names | Dell, Ford, Bloomberg | Personal brands |
| **Descriptive** | Literal description | General Electric, PayPal | Clear positioning |
...
- `-hub`: GitHub, HubSpot, PornHub
- `-ment`: Segment, Element, Moment
- `-able`: Airtable, Notable, Readable
...
- `super-`: Superhuman, Supercell

### 3. Brandability Scoring

Evaluate generated names using this scoring system:
...
Integrate with the `search-domain-validator` skill for availability checking:
