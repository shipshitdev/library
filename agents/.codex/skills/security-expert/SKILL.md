...
**Before providing security guidance, discover the project's context:**

1. **Scan Project Documentation:**
   - Check `.agent/SYSTEM/ARCHITECTURE.md` for security architecture
   - Review `.agent/SYSTEM/critical/CRITICAL-NEVER-DO.md` for security rules
...
4. Ensures multi-tenancy and data isolation
5. Implements secure coding patterns
6. Configures security headers and CORS
7. Validates all inputs
8. Protects sensitive data
