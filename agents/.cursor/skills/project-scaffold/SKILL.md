...
**Script not found**: Ensure the skill is installed in `~/.cursor/skills/project-scaffold/`

**Permission denied**: Make script executable: `chmod +x ~/.cursor/skills/project-scaffold/scripts/scaffold.py`
