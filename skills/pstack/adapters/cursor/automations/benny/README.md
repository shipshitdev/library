...
3. resolve canonical Shipshit dependencies through the target harness. Preserve its role configuration and verify project-scoped discovery in a fresh agent. Do not enable the upstream plugin.
...
5. commit the approved project skill registration, `.cursor/automations/benny/`, and any secret-free configuration before enabling either automation.
