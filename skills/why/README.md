...
Queries available evidence categories in parallel and returns a confidence-separated, cited read.
...
| Field | Value |
|-------|-------|
| Source | [`pstack/skills/why/SKILL.md`](https://github.com/cursor/plugins/blob/main/pstack/skills/why/SKILL.md) |
| Upstream ref | `main` |
