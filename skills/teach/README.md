...
Runs how and why, then teaches at the person's pace with growing diagrams.
...
| Field | Value |
|-------|-------|
| Source | [`pstack/skills/teach/SKILL.md`](https://github.com/cursor/plugins/blob/main/pstack/skills/teach/SKILL.md) |
| Upstream ref | `main` |
