...
- **Category**: correctness | security | perf | tests | tech-debt | deps-migrations | dx | docs | direction
...
Generated by the codebase-advisor skill on <date>. Execute in the order below unless
