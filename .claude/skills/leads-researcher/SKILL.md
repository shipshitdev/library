...
This skill enables Claude to research leads by gathering company information, discovering contact details, and identifying buyer intent signals. Claude will use this skill to find company data (industry, size, location, tech stack), locate contact information (emails, phone numbers, social profiles), and identify buying signals (job postings, technology usage, news).
...
- Need to discover contact information (emails, phone numbers)
- Want to identify buyer intent signals
- Need to enrich lead data with additional information
- Want to find decision makers at companies
- Need to research tech stack or technology usage
...
1. **Scan Project Documentation:**
   ...
   - Check for existing lead research tools or processes
   - Review data sources and APIs in use
   - Look for lead data schemas or structures
...
3. **Use Project-Specific Skills:**
   - Check for `[project]-leads-researcher` skill
   - Review project-specific research workflows
...
async function researchCompany(companyName: string, domain?: string) {
  ...
  // Use Crunchbase API for funding/revenue
  // Use Apollo.io for additional company data
  // Use LinkedIn for employee count and industry
