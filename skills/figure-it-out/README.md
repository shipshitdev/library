...
For large migrations and unattended work. Designs the workflow, runs a hypothesis loop, and logs decisions.
...
| Field | Value |
|-------|-------|
| Source | [`pstack/skills/figure-it-out/SKILL.md`](https://github.com/cursor/plugins/blob/main/pstack/skills/figure-it-out/SKILL.md) |
| Upstream ref | `main` |
