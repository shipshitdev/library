...
python3 ~/.codex/skills/tailwind-validator/scripts/validate.py --root .

# Validate with auto-fix suggestions
python3 ~/.codex/skills/tailwind-validator/scripts/validate.py --root . --suggest-fixes

# Strict mode (fail on any v3 pattern)
python3 ~/.codex/skills/tailwind-validator/scripts/validate.py --root . --strict
```
...
- name: Validate Tailwind v4
  run: |
    python3 ~/.codex/skills/tailwind-validator/scripts/validate.py \
      --root . \
      --strict \
      --ci
```
