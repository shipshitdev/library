...
```bash
python3 ~/.codex/skills/nextjs-validator/scripts/validate.py --root .
python3 ~/.codex/skills/nextjs-validator/scripts/validate.py --root . --strict
```
...
- name: Validate Next.js 16
  run: |
    python3 ~/.codex/skills/nextjs-validator/scripts/validate.py \
      --root . \
      --strict \
      --ci
```
