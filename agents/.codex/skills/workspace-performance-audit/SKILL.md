...
This skill orchestrates a comprehensive performance audit across an entire monorepo workspace. It coordinates multiple specialized skills to analyze frontend (Next.js), backend (NestJS), database (MongoDB), browser extensions (Plasmo), and shared packages—delivering a consolidated report with prioritized recommendations.
...
- Say "audit performance", "check workspace performance", "performance review"
- Need to identify bottlenecks across frontend, backend, and extensions
- Want consolidated performance metrics and recommendations
...
// Core Web Vitals
// Run: npx lighthouse https://app.genfeedai.com --output=json
...
## Detailed Reports
- [Frontend Report](#phase-1)
- [Backend Report](#phase-2)
- [Database Report](#phase-3)
- [Extension & Packages Report](#phase-4)
...
```
User: "Quick performance check on GenFeedAI"

Orchestrator:
- Phase 0: Workspace discovery
- Phase 1: Frontend Core Web Vitals only
- Phase 2: API response times only
- Phase 5: Quick summary

Output: 1-page summary with top 5 issues
```

### Full Audit (Comprehensive)

```
User: "Full performance audit on GenFeedAI workspace"
...
Output: Full report with all domains covered
```

### Domain-Specific Audit

```
User: "Audit frontend performance only"

Orchestrator:
- Phase 0: Discovery (frontend only)
- Phase 1: Full frontend audit
- Phase 5: Frontend-specific report
```
