...
188 AI agent skills for development workflows. Works with Claude Code, OpenAI Codex, and Cursor.

Catalog: **188 skills · 30 commands · 13 bundles · 201 plugins**.
<!-- catalog-summary:end -->
...
| `.claude-plugin/` | Generated Claude marketplace catalog | 201 generated plugins |
...
| `skills/` | Canonical public Agent Skills sources | 188 canonical skills |
