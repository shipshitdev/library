...
For project-specific patterns, verify (discover from project structure):

```bash
# Check serializers location (discover from project)
ls [packages-project]/packages/common/serializers/

# Check interfaces location (discover from project)
find [packages-project]/packages -name "interfaces" -type d

# Check GitHub workflows
find . -path "*/.github/workflows/*.yml" -not -path "*/node_modules/*"

# Verify project structure (discover from project)
ls -d [project-pattern]*/
```
