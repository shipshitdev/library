...
```bash
python3 ~/.codex/skills/biome-validator/scripts/validate.py --root .
python3 ~/.codex/skills/biome-validator/scripts/validate.py --root . --strict
```
...
- name: Validate Biome Config
  run: |
    python3 ~/.codex/skills/biome-validator/scripts/validate.py \
      --root . \
      --strict \
      --ci
