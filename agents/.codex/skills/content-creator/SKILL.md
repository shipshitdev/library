...
- Ask for content lineups or content calendars
- Want content that matches their voice and brand
- Need help generating content ideas
...
### Voice & Tone (Discover from Project)
...
**Tweet Types (Discover from Project):**

- Updates: Project progress, launches, milestones
- Insights: Learnings, tips, observations
- Questions: Engage audience, gather feedback
- Resources: Links, tools, recommendations
- Stories: Personal experiences, behind-the-scenes
- Promotional: Product updates, features (match project's promotional style)

## Content Lineup Generation

When users request a content lineup, generate a comprehensive content plan for the **current project** based on discovered project context.
...
- Include project-specific context throughout
...
- **Copywriter**: For brand voice consistency
- **Strategy-expert**: For content strategy and planning
